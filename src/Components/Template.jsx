...
function PdfTemplate(props){
    ...
    return(
        ...
        <ReactToPrint trigger={()=><button type="button" class="btn btn-danger">Print</button>} content={()=> ref.current} documentTitle={`Invoice ${props.InvoiceNumber}`}/>
        <button type="button" class="btn btn-success " onClick={()=>setAirPopup(true)}>Add products</button>
        </div>
